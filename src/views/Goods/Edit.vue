	...
	<el-card class="box-card">
		...
		<el-form ref="form" :model="form" :rules="rules" label-width="100px" label-position="left">
			...
			<el-form-item label="商品轮播图" prop="slider">
				<el-upload action="/api/upload/goods" :file-list='photo' list-type="picture-card" :on-success="sliderSuccess"
			...
			return {
				...
				rules: {
					name: [
						...
						{ min: 1, max: 2000, message: '长度在 1 到 20 个字符', trigger: 'blur' }
					],
					hotPoint: [
					...
					price: [
						...
						{ type:'number', min: 0, max: 99999, message: '价格在 0 到 99999 之间', trigger: 'blur' }
					],
					marketPrice: [
						{ required: true, message: '请输入市场价', trigger: 'blur' },
						{ type:'number', min: 0, max: 99999, message: '市场价格在 0 到 99999 之间', trigger: 'blur' }
					],
					cost: [
					...
					articleNo: [
						...
						{ type:'number', min: 0, max: 99999, message: '货号在 0 到 99999 之间', trigger: 'blur' }
					],
					img_md: [
					...
					freight: [
						...
						{ type:'number', min: 1, max: 1000, message: '运费在 1 到 1000 之间', trigger: 'blur' }
					]
				}
			}
		},
